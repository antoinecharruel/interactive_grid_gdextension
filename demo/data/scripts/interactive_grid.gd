...
func _process(delta: float) -> void:
	...
	if pawn_player != null:
		...
		if self.get_selected_cells().is_empty():
			...
			var index_pawn_cell: int = self.get_cell_index_from_global_position(self.get_grid_center_position())
...
func open_grid():
	if player_pawn_collision_shape_3d != null:
				...
				#var index_pawn_cell: int = self.get_cell_index_from_global_position(player_pawn_collision_shape_3d.global_position)
